...
<body>
    ...
    @endif
        ...
        <form action="{{ route('userinfos.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="form-group my-3">
                        <strong>Phone</strong>
                        <input type="text" name="phone" class="form-control" placeholder="Type Phone Number">
                        @error('phone')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                    </div>
                ...
                <div class="col-md-12">
                    <div class="form-group my-3">
                        ...
                        <input type="text" name="nationality" class="form-control" placeholder="Type Nationality">
                        @error('nationality')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                    </div>
                ...
                <div class="col-md-12">
                    <div class="form-group my-3">
                        <strong>ADMIN</strong>
                        <input type="text" name="is_admin"  class="form-control" placeholder="Type 0 For User / Type 1 For Admin">
                        @error('is_admin')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                    </div>
